...
const Location = () => {
    ...
    return (
        <Wrapper>
            ...
            <Image src={Flower} />
            <Map id="daumRoughmapContainer1753587778659" className="root_daum_roughmap root_daum_roughmap_landing"></Map>
            <Content>
                <Title>찾아오시는 길</Title>
                <br />
                ...
                <a
                    ...
                    style={{ color: "#3A6B5A", textDecoration: "underline", fontWeight: "normal", fontSize: "0.95em" }}
                >
                    카카오지도
                </a>
                &nbsp;|&nbsp;
                ...
                {showBusDetails && (
                    <BusDetails>
                        ...
                        >
                            ...
                            >
                                {["1004", "8600", "8601", "9709", "9709N", "9710", "9710-1", "G6005"].map((bus, index) => (
                                    <span
                                        key={index}
                                        style={{
                ...
                <br />
                승용차를 가져오시는 경우 <span style={{ fontWeight: "bold" }}>이화정동빌딩 주차장</span>을 이용하시기 바랍니다.
                <br />
                <br />
                <Title>축하 화환</Title>
                <br />
