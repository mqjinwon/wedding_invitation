...
export const useEnvironmentVariables = () => {
  return {
    ...
    WEDDING_INVITATION_URL: process.env.WEDDING_INVITATION_URL || "https://mqjinwon.github.io/wedding_invitation",
    ...
    // 공유 이미지 (공개 URL)
    KAKAOTALK_SHARE_IMAGE: "https://cdn.pixabay.com/photo/2014/11/13/17/04/heart-529607_960_720.jpg",
  };
};
